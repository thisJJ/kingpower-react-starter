const prod = {
  env: 'prod',
  hostname: 'kpc.kingpower.com',
  port: 9000,
  protocol: 'https',
  apiEndpoint: 'https://api.kingpowerclick.com',
  facebookAppId: '1601307813265666',
  gtmId: 'GTM-5P47RKW',
  paymentOmisePublicKey: 'pkey_5aiym0iiznb4u2z35yu',
  paymentOmise: 'https://payment-gateway.kingpowerclick.com/paymentgateway/charges/omise',
  paymentAlipay: 'https://payment-gateway.kingpowerclick.com/paymentgateway/charges/alipay',
  paymentTransactionStatus: 'https://payment-gateway.kingpowerclick.com/paymentgateway/transactions',
  clientSecret: '',
  ...
  webUrl: 'https://www.kingpower.com',
